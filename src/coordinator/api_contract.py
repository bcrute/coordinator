...
def openapi_document() -> dict[str, Any]:
    ...
    schemas: dict[str, Any] = {
        ...
        "ExecutorSettingsPatch": {
            "type": "object",
            "properties": {
                "primary_adapter": {"enum": ["codex", "claude", "mini-swe-agent"]},
                "primary_claude_model": {"type": "string", "minLength": 1},
                "primary_claude_effort": {"type": "string"},
                "primary_local_model": {"type": "string"},
                "primary_local_effort": {"type": "string"},
                "primary_local_step_limit": {"type": "integer", "minimum": 6, "maximum": 200},
                "primary_local_timeout_seconds": {"type": "integer", "minimum": 10, "maximum": 86400},
                ...
                "claude_max_turns": {"type": "integer", "minimum": 8, "maximum": 200},
                ...
                "mini_swe_step_limit": {"type": "integer", "minimum": 6, "maximum": 200},
